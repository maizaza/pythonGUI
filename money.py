...
Combo["values"]=("EUR","JPY","USD","GBP","DONG")
...
Button(text="คำนวน",font=30,width=15,command=calculate,background="green").grid(row=3,column=1,sticky=W)
Button(text="ล้าง",font=30,width=15,command=clear,background="red").grid(row=3,column=1,sticky=E)
