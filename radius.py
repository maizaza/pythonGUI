...
btn1=Button(text="คำนวน",command=caculate,background="green",width=15).grid(row=2,column=1,sticky=W)
btn1=Button(text="ล้าง",command=deletetext,background="red",width=15).grid(row=2,column=1,sticky=E)
root.mainloop()